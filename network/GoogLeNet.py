...
class GoogLeNet(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False, init_weights=True):
        ...
        self.conv1 = BasicConv2d(3, 64, kernel_size=7, stride=2, padding=3)  # 步长为2相当于做了缩放
        self.maxpool1 = nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=True)  # 池化
        self.conv2 = BasicConv2d(64, 64, kernel_size=1)  # 做1*1的卷积
        self.conv3 = BasicConv2d(64, 192, kernel_size=3, padding=1)  # 普通卷积呗
        self.maxpool2 = nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=True)  # 池化
...
def googlenet(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = load_url(model_urls['googlenet'], progress=progress)
